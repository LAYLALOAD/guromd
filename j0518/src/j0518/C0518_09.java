...
public class C0518_09 {
	...
	public static void main(String[] args) {
		// 자판기 프로그램
		// 1. 밀크커피 - 300 2.헤이즐넛커피 - 500 3.블랙커피 - 350 4.코코아 - 300 5.우유 - 400 6.잔액충천
	...
	//음료 제조 메소드
	static int order(int myMoney, int price, String item) {
		if(myMoney>=price) {
			System.out.println(item+"가 자동으로 나옵니다.");
			myMoney = myMoney - price; // myMoney -= 300; 같음					
		}else {
